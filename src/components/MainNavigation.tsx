                    ...
                    <div className="main-page-header">
                        <div className="header-inner">
                            ...
                            <nav className="header-nav">
                                <Link className="link link-main-page" to={SEARCH_PAGE_URL}>Explore</Link>
