...
export function Element({ element }: ElementProps) {
    ...
    function DislikedButton() {
        return (
            <button className="image-button like-button" id="like" onClick={handleLikeClick}>
    ...
    function LikedButton() {
        return (
            <button className="image-button like-button" id="like" onClick={handleDislikeClick}>
                <svg className="spacing_noMargin__Q_PsJ" viewBox="0 0 24 24" width="24" height="24">
