...
export function Element ({element}: ElementProps){
    ...
    // function showInformation(e: HTMLElement){
    //     e.style.background = "";
    // }
        ...
        < >
            <div className="image-card">
                <div className="shadow">
                    <img className="image" src={element.src.original} alt={element.alt}  onClick={() => setIsShowDetails(true)}/>
                    <div className="image-information">
                        ...
                        <div className="information-footer">
                            <div className="photographer">
                                ...
                                <div className="name">{element.photographer}</div>
                            </div>
                            <button className="image-button">
                                <svg className="spacing_noMargin__Q_PsJ" viewBox="0 0 24 24" width="24" height="24">
            ...
            {isShowDetails && <form>
                <button onClick={() => setIsShowDetails(false)}> Закрыть </button>
